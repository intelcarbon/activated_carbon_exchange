// pages/activation-techniques.tsx
  ...
  return (
    <div className="p-6 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold mb-4 text-gray-900">Activation of Activated Carbon</h1>
        ...
        <h2 className="text-2xl font-semibold mb-3 text-gray-800">Physical Activation</h2>
        ...
        <h2 className="text-2xl font-semibold mb-3 text-gray-800">Chemical Activation</h2>
        <p className="text-gray-700 mb-4">
        ...
        <h2 className="text-2xl font-semibold mb-3 text-gray-800">Factors Influencing Activation</h2>
        <ul className="list-disc list-inside text-gray-700 mb-4">
          <li>
            <strong>Precursor Material:</strong> The choice of precursor (e.g., Coconut Shell, wood, peat) significantly affects the characteristics of the activated carbon produced. Different materials respond uniquely to activation processes, influencing the pore structure and chemical properties of the final product.
          </li>
          <li>
            <strong>Activating Agent:</strong> The type and concentration of the activating agent play crucial roles in chemical activation, determining the pore structure and surface chemistry of the activated carbon.
          </li>
          <li>
            <strong>Temperature and Time:</strong> Both physical and chemical activation processes are influenced by the temperature and duration of the activation process. These factors need to be optimized to maximize the development of the desired pore structure and surface area.
          </li>
        </ul>
